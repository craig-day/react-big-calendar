...
var MonthView = _react2['default'].createClass({
  ...
  renderWeek: function renderWeek(week, weekIdx, content) {
    ...
    var _endOfRange = _utilsEventLevels.endOfRange(week);
  ...
  renderRowLevel: function renderRowLevel(segments, week, idx) {
    var _endOfRange2 = _utilsEventLevels.endOfRange(week);
  ...
  renderShowMore: function renderShowMore(segments, extraSegments, week, weekIdx) {
    ...
    var _endOfRange3 = _utilsEventLevels.endOfRange(week);
      ...
      return _react2['default'].createElement(
        'div',
        {
          ...
          className: _classnames2['default']('rbc-date-cell', {
            ...
            'rbc-current': _utilsDates2['default'].eq(day, _this6.props.date, 'day')
          })
        },
        _react2['default'].createElement(
          'a',
