...
function eventSegments(event, first, last, _ref) {
  ...
  var end = _dates2['default'].min(_dates2['default'].ceil(_accessors.accessor(event, endAccessor), 'day'), last);
...
function inRange(e, start, end, _ref2) {
  ...
  var eStart = _dates2['default'].startOf(_accessors.accessor(e, startAccessor), 'day');
  var eEnd = _dates2['default'].ceil(_accessors.accessor(e, endAccessor), 'day');
